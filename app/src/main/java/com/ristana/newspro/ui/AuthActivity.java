...
public class AuthActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener
{
    ...
    public void initAction(){
        ...
        this.button_sign_in_email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                if(response.body()!=null){
                    ...
                    if (response.body().getCode()==500){
                        Toasty.error(getApplicationContext(), getResources().getString(R.string.operation_cancelled), Toast.LENGTH_SHORT, true).show();
                    }
                }else{
                    Toasty.error(getApplicationContext(), getResources().getString(R.string.operation_cancelled), Toast.LENGTH_SHORT, true).show();
                }
