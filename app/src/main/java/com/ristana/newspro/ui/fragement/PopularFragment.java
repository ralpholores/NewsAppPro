...
public class PopularFragment extends Fragment {
    ...
    private RelativeLayout relative_layout_popular_fragment_error;
    private RelativeLayout relative_layout_popular_fragment;
    private Button button_try_again;
    private RelativeLayout relative_layout_popular_fragment_load_more;
    ...
    private void initView() {
        ...
        this.relative_layout_popular_fragment_error=(RelativeLayout) view.findViewById(R.id.relative_layout_popular_fragment_error);
        ...
        this.relative_layout_popular_fragment_load_more=(RelativeLayout) view.findViewById(R.id.relative_layout_popular_fragment_load_more);
        swipe_refreshl_popular_fragment.setProgressViewOffset(false,00,200);
        ...
        recycle_view_popular_fragment.setAdapter(articleAdapter);
    ...
    private void loadNexArticles() {
        relative_layout_popular_fragment_load_more.setVisibility(View.VISIBLE);
        Retrofit retrofit = apiClient.getClient();
        apiRest service = retrofit.create(apiRest.class);
        Call<List<Article>> call = service.articlesAll(page,"views",Integer.parseInt(prefManager.getString("LANGUAGE_DEFAULT")));
        call.enqueue(new Callback<List<Article>>() {
            ...
            public void onResponse(Call<List<Article>> call, Response<List<Article>> response) {
                ...
                relative_layout_popular_fragment_load_more.setVisibility(View.GONE);
    ...
    public void popularAll() {
        ...
        Retrofit retrofit = apiClient.getClient();
        apiRest service = retrofit.create(apiRest.class);
        Call<Global> call = service.homePopular(Integer.parseInt(prefManager.getString("LANGUAGE_DEFAULT")));
        call.enqueue(new Callback<Global>() {
            ...
            public void onResponse(Call<Global> call, Response<Global> response) {
                if (response.isSuccessful()){
                    ...
                    if (response.body().getTags().size()>0){
                        articleList.add(new Article().setTypeView(6));
                        for (int i = 0; i < response.body().getTags().size(); i++) {
                            tagList.add(response.body().getTags().get(i));
                        }
                        tagList.add(null);
                    }
                    ...
                    articleAdapter.notifyDataSetChanged();
                    relative_layout_popular_fragment_error.setVisibility(View.GONE);
                    relative_layout_popular_fragment.setVisibility(View.VISIBLE);
                }else{
                    relative_layout_popular_fragment_error.setVisibility(View.VISIBLE);
                    relative_layout_popular_fragment.setVisibility(View.GONE);
                }
