    ...
    public void onBindViewHolder(ChoiceHolder holder, final int position) {
        ...
        switch (step){
            case 1:
                ...
                holder.relative_layout_item_question_choice_value.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_choice_1));
            ...
            case 2:
                ...
                holder.relative_layout_item_question_choice_value.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_choice_2));
                break;
            case 3:
                ...
                holder.relative_layout_item_question_choice_value.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_choice_3));
                break;
            case 4:
                ...
                holder.relative_layout_item_question_choice_value.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_choice_4));
                break;
            case 5:
                ...
                holder.relative_layout_item_question_choice_value.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_choice_5));
                break;
        }
    }
